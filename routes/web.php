...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::prefix('products')->group(function () {
        ...
        Route::post('/search-products-revenue', [AdminProductController::class, 'searchRevenueProducts'])->name('admin.product.searchRevenueProducts');;
        Route::get('/get-product-revenue/{id}', [AdminProductController::class, 'getRevenueByProduct'])->name('admin.product.getRevenueByProduct');;
    });
